        ...
        <div class="space-y-3 pt-5 ">
          <div class="flex justify-between items-center">
            <label class="text-[10px] font-black uppercase tracking-widest text-slate-300 flex items-center gap-2">
              <Icon name="ri:text" class="text-sm text-emerald-400" />
              Text Overlays
            </label>
            <div class="flex items-center gap-2">
              <button 
                ...
                class="flex items-center gap-1.5 bg-white/5 hover:bg-white/10 text-slate-300 border border-white/10 h-8 px-3 rounded-xl text-[9px] font-black uppercase tracking-wider transition-all active:scale-95 hover:text-white"
          ...
          >
            ...
            <div class="px-4 py-3 border-b border-surface-border/50 flex justify-between items-center bg-white/[0.02]">
              <div class="flex items-center gap-2">
                <Icon name="ri:text" class="text-emerald-400 text-sm" />
                <span class="text-[10px] font-bold uppercase tracking-widest text-emerald-400">Text {{ Number(idx) + 1 }}</span>
              </div>
              <button 
            ...
            <div class="p-3.5 space-y-3.5 select-none">
              ...
              <div class="flex bg-black/40 border border-white/5 rounded-xl p-1 gap-1">
                <button 
                  ...
                  :class="getActiveTab(overlay.id) === t.id ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20 shadow-sm' : 'text-slate-400 hover:text-white'"
                >
              ...
              <div class="bg-black/20 border border-white/5 rounded-xl p-3.5 space-y-3.5 min-h-[140px] flex flex-col justify-center">
                ...
                <div v-if="getActiveTab(overlay.id) === 'text'" class="space-y-3 animate-in fade-in duration-200 w-full">
                  <textarea 
                    ...
                    rows="5"
                    class="w-full bg-black/40 border border-white/10 rounded-lg px-3 py-2 text-white text-xs focus:outline-none focus:border-emerald-500/50 resize-none transition-all"
                  ...
                  <div>
                    ...
                    <div class="flex gap-1">
                      <button 
                        ...
                        :class="overlay.textTransform === t ? 'bg-emerald-500/20 border-emerald-500/40 text-emerald-400' : 'bg-transparent border-white/10 text-slate-500 hover:text-slate-400'"
                      >
                ...
                <div v-else-if="getActiveTab(overlay.id) === 'style'" class="space-y-3 animate-in fade-in duration-200 w-full">
                  <div>
                    ...
                    <select 
                      ...
                      class="w-full bg-black/40 border border-white/10 rounded-lg px-3 py-2 text-white text-xs focus:outline-none focus:border-emerald-500/50 appearance-none cursor-pointer"
                    >
                  ...
                  <div class="flex items-center justify-between py-1">
                    ...
                    <button 
                      ...
                      :class="overlay.showStroke ? 'bg-emerald-500' : 'bg-white/10'"
                    >
